...
<title>WEB-2U.COM находится в стадии строительства..</title>
<meta content="-1" http-equiv="expires"><meta content="no-cache" http-equiv="pragma"><meta name="viewport" content="width=device-width; initial-scale=1.0"><link href="favicon.ico" rel="Bookmark Icon">
<style type="text/css">
body{font-size:100.1%;font-family:Arial,Helvetica,Sans-Serif,Calibri,"Trebuchet MS";color:#FAFAFA;background-color:#555;padding:0;margin:0;
background-image:-webkit-gradient(linear, 100% 90%, 75% 90%, from(black), to(#888));
background-image:
-webkit-linear-gradient(115deg, #777 23px, transparent 23px),
-webkit-linear-gradient(295deg, #777 23px, transparent 23px),
-webkit-linear-gradient(115deg, #777 23px, transparent 23px),
-webkit-linear-gradient(295deg, #777 23px, transparent 23px);
background-size:58px 58px;
background-position:0px 2px, 4px 35px, 29px 31px, 34px 6px;/*60px 50px, 2px 50px, 2px 50px, -60px 0px*/
word-wrap:break-word;
}
.lineStop{background-color:#000;-webkit-transition:all 2.2s ease-in-out;
background-image:-webkit-gradient(linear, 10% 10%, 10% 170%, from(red), to(transparent));
background-image:
-webkit-repeating-linear-gradient(135deg,
transparent,
transparent 15px,
rgba(217, 217, 52, 0.5) 15px,
rgba(217, 217, 52, 0.5) 30px);
width:100%;min-height:2em;height:10%;margin:3% 0;padding:2% 0;border-top:solid 1px #000;border-bottom:solid 1px #000;box-shadow:0 0 1em 0.2em #000;}
.LenguageMenu_Stoper{background-color:rgba(0,0,0,0.6);border-bottom:1px solid #444;box-shadow:1px 1px 5px rgba(0, 0, 0, 0.7);display:inline-block;margin:0 0 3%;padding:0;text-align:center;width:100%;}
.DivLeng{margin:0;display:inline;}
.ALeng:hover,a:hover{background-color:#6D6D1A;border-radius:3px;box-shadow:0 0 3px #FFFFFF inset;}
.ALeng{
color:#FFFFFF;
...
h1{-webkit-transition:all 2.2s ease-in-out;
...
1px 1px 0 rgb(158,158,158),
2px 2px 0 rgb(115,115,115),
3px 3px 2px rgba(0,0,0,0.45),
3px 3px 1px rgba(0,0,0,0.5),
0px 0px 2px rgba(0,0,0,.2);
}
h1:hover{color:red;}
h3{text-align:center;color:#E5E5E2;margin:0;text-align:center;text-shadow:1px 1px 1px #000000;font-weight:normal;}
...
<div id="cntrlLanguageMenu_div_en" class="DivLeng"><a id="cntrlLanguageMenu_a_en" title="English" class="ALeng a_en" href="index.htm">English</a></div>
